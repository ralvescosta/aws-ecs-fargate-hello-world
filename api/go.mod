module github.com/ralvescosta/aws-ecs-fargate-hello-world/api
...
require (
	...
	github.com/ralvescosta/gokit/metrics v1.16.0 // indirect
...
require (
	...
	github.com/ralvescosta/gokit/httpw v1.17.0
